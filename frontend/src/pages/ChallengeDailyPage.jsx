...
import { getAPIDailyChallengeData, putAPIDailyChallengeAnswer } from "../utilities";
...
export default function ChallengeDailyPage() {
    ...
    const [editorCode, setEditorCode] = useState("// Start typing your c\node ..")
    ...
    return ( 
    <>
      <div className="flex h-200">{/* this holds 2 columns */}
        <section className="w-1/2 p-3  overflow-auto" >
          {dailyChallengeData?
            <ChallengeDisplay htmlData={dailyChallengeData.html}/>
            :null
          }
        </section>
        ...
        <section className="w-1/2 p-3">
          ...
          <div className="mx-auto h-3/4 bg-white rounded-xl shadow-md">
            <MonacoEditor language={editorLanguage} editorCode={editorCode} setEditorCode={setEditorCode}/>
          </div>
